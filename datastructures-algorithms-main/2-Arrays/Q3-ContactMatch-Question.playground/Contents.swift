...
func practice(_ a:[String], _ b:[String], _ c:String) -> [String] {
    var practiceResult = [String]()
    
//    for k in b {
//        for t in k {
//            if String(t).contains(c) {
//                practiceResult.append(String(t))
//            }
//        }
//    }
...
//print(practice(["Ann", "Jake", "Dave"], ["8765", "99988", "7676"], "8"))
